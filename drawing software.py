#add it so the borders for the size menu is added in the medium and large screen 
run = True
while run: 
...
def clicked(x,y):
  ...
  if circle_color.distance(x,y) < 30:
    if m_open == False:
      ...
      if bigness == "small":
       ...
       b_blue.dot(50)
       b_green.goto(green.xcor(),black.ycor()-370)
       b_green.dot(50)
       valu2 = 40
  ...
  if b_green.distance(x,y) < value2:
   if m_open == True:
    button_click = True
    if b_color != "green":
      turtle.clear()
  ...
  if button_click == False:
   ...
   if bigness == "small":
     if size_menu_on == 2 and x < 100 and m_open == True and b_menu_on == 2 and y > -150 and x > -130:
       checker2 = 2
       already_drawn = True
       tap = True
       movedx.append(x)       
     ...
     if checker != 2:
      if size_menu_on == 2 and x < 100 and  m_open == False and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
     ...
     if checker2 != 2:  
      if size_menu_on == 2 and x < 100 and m_open == True and x > -130 and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
     ...
     if checker2 != 2:
      if size_menu_on == 2 and x < 100 and b_menu_on == 2 and y > -150 and m_open == False:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
     ...
     if m_open == True and b_menu_on == 2 and y > -150 and x > -130 and size_menu_on != 2: 
      checker = 1
      already_drawn = True
      tap = True
      movedx.append(x)       
     ...
     if checker != 1:
      if m_open == True and x  > -130 and size_menu_on != 2:
       if b_menu_on != 2:
        if tap == False:
         already_drawn = True
         tap = True
     ...
     if b_menu_on != 2 and m_open == False and size_menu_on != 2:
       if tap == False:
        tap = True
        movedx.append(x)
        movedy.append(y)
   ...
   if bigness == "medium":
    ...
    if size_menu_on == 2 and x < 195 and m_open == True and b_menu_on == 2 and y > -250 and x > -205:
       checker2 = 2
       already_drawn = True
       tap = True
       movedx.append(x)       
    ...
    if checker != 2:
      if size_menu_on == 2 and x < 195 and  m_open == False and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if checker2 != 2:  
      if size_menu_on == 2 and x < 195 and m_open == True and x > -205 and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if checker2 != 2:
      if size_menu_on == 2 and x < 195 and b_menu_on == 2 and y > -250 and m_open == False:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if m_open == True and b_menu_on == 2 and y > -250 and x > -205 and size_menu_on != 2: 
      checker = 1
      already_drawn = True
      tap = True
      movedx.append(x)       
    ...
    if checker != 1:
      if m_open == True and x  > -205 and size_menu_on != 2:
       if b_menu_on != 2:
        if tap == False:
         already_drawn = True
         tap = True
    ...
    if checker != 1:
      if b_menu_on == 2 and y > -250 and size_menu_on != 2:
       if m_open == False:
        if tap == False:
         if already_drawn == False:
          tap = True
   ...
   # y =-252 and -x = 550
   if bigness == "large":
    if size_menu_on == 2 and x < 550 and m_open == True and b_menu_on == 2 and y > -250 and x > -490:
       checker2 = 2
       already_drawn = True
       tap = True
       movedx.append(x)       
    ...
    if checker != 2:
      if size_menu_on == 2 and x < 550 and  m_open == False and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if checker2 != 2:  
      if size_menu_on == 2 and x < 550 and m_open == True and x > -550 and b_menu_on != 2:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if checker2 != 2:
      if size_menu_on == 2 and x < 550 and b_menu_on == 2 and y > -250 and m_open == False:
       already_drawn = True
       tap = True
       movedx.append(x)       
       movedy.append(y)
    ...
    if m_open == True and b_menu_on == 2 and y > -250 and x > -550 and size_menu_on != 2: 
      checker = 1
      already_drawn = True
      tap = True
      movedx.append(x)       
    ...
    if checker != 1:
      if m_open == True and x  > -550 and size_menu_on != 2:
       if b_menu_on != 2:
        if tap == False:
         already_drawn = True
         tap = True
